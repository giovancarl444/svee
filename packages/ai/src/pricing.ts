 ...
 * is never under-reported. Re-check the live-docs page when pricing drifts.
 */
...
// Placeholder rates — see VERIFY note above. Keyed by model-id prefix.
...
const FALLBACK: Rate = { inputPerM: 3, outputPerM: 15 };
