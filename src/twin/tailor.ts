...
const RESOLVERS: Resolver[] = [
  ...
  { match: /^\s*why\b|\bwhy (do|are|would|should|this|us|our|the)\b|\bvarför\b|motivation|what (interests|draws|excites) you|interested in (this|the|our|joining|working)/i, resolve: (kb) => kb.screeningAnswers.whyNow },
